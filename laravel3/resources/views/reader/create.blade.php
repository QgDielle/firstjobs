  ...
  <div class="row justify-content-center text-center">
   <div class="col-12">
    <h1 class="display-2 p-3 tx-p">
     Inserisci il tuo E-book preferito!
    </h1>
   </div>
  </div>
 </div>
 ...
 <div class="container-fluid p-5 bg-custom">
  <div class="row justify-content-center">
   <div class="col-12 col-md-8">
    ...
    <form class="p-5 border tx-p bg-light" method="POST" action="{{route('reader.store')}}" enctype="multipart/form-data">
     ...
     <button class="btn btn-cst center shadow tx-p mt-3" type="submit">Share you E-book!</button>
    </form>
